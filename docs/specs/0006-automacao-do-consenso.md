...
Continuam abertas, e as duas passaram por rodada 1 cega em 2026-09-03, registrada em `docs/archive/CONSENSUS-2026.md` (rotacionada por tamanho em 2026-09-03), entrada "2026-09-03 - P-7 e P-8". **As tres posicoes convergiram no que fazer nas duas**, e o que sobrou para o usuario e calibragem, nao empate:
